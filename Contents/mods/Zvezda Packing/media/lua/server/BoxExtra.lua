--Return additional Books upon opening --
function Box_OpenCarpentry(items, result, player)
...
function Box_OpenTrapping(items, result, player)
...
function Box_OpenFishing(items, result, player)
...
function Box_OpenMechanics(items, result, player)
...
function Box_OpenFirstAid(items, result, player)
...
function Box_OpenMetalwork(items, result, player)
...
function Box_OpenElectricity(items, result, player)
...
function Box_OpenCooking(items, result, player)
...
function Box_OpenFarming(items, result, player)
...
function Box_OpenForaging(items, result, player)
...
function Box_OpenTailoring(items, result, player)
